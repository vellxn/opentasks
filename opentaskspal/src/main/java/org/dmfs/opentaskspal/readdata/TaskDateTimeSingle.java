 ...
 */
public final class TaskDateTimeSingle implements Single<DateTime>
{
    ...
    public TaskDateTimeSingle(@NonNull Long timestamp, @NonNull String timeZoneId, @NonNull Boolean isAllDay)
    {
    ...
    public TaskDateTimeSingle(@NonNull CharSequence timestamp, @NonNull CharSequence timeZoneId, @NonNull CharSequence isAllDay)
    {
        this(Long.valueOf(timestamp.toString()), timeZoneId.toString(), "1".equals(isAllDay.toString()));
    }


    public TaskDateTimeSingle(@NonNull CharSequence timestamp, @NonNull RowDataSnapshot<Tasks> rowData)
    {
