...
{
    private final RowDataSnapshot<TaskContract.Tasks> mTaskData;


    public EffectiveTimezone(RowDataSnapshot<TaskContract.Tasks> taskData)
    {
        mTaskData = taskData;
    }
    ...
    {
        return new Mapped<>(new TimeZoneFunction(), mTaskData.charData(TaskContract.Tasks.TZ)).value(TimeZone.getDefault());
    }
